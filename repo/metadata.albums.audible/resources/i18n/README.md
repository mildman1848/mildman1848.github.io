...
python3 tools/export_kodi_pot.py \
  --source repo/metadata.albums.audible/resources/language/resource.language.en_gb/strings.po \
  --output repo/metadata.albums.audible/resources/language/strings.pot
```
